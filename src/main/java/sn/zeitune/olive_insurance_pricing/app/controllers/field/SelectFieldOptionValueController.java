...
public class SelectFieldOptionValueController {
    ...
    public ResponseEntity<SelectFieldOptionValueResponseDTO> create(
        ...
        SelectFieldOptionValueResponseDTO response = selectFieldOptionValueService.create(selectFieldOptionValueRequestDTO, ((Employee)authentication.getPrincipal()).getManagementEntity());
...
//    }
    ...
    public ResponseEntity<Page<SelectFieldOptionValueResponseDTO>> getAll(
        @PageableDefault(size = 20) Pageable pageable,
        Authentication authentication
    ) {
        log.info("REST request to get all field possibilities values with pagination");
        Page<SelectFieldOptionValueResponseDTO> response = selectFieldOptionValueService.findAll(pageable, ((Employee)authentication.getPrincipal()).getManagementEntity());
